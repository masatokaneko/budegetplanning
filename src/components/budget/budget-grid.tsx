        ...
        <div className="min-w-[1400px]">
          ...
          {accounts.map((account) => (
            <div key={account} className="space-y-1">
              ...
              {/* 勘定科目合計行 */}
              <div className="grid grid-cols-[200px_150px_120px_100px_repeat(12,80px)_100px] gap-1 py-1 border-t-2 border-gray-200 bg-gray-50">
                <div className="flex items-center text-sm font-medium">{account} 合計</div>
                <div></div>
                <div></div>
                <div></div>
                {months.map((_, monthIndex) => (
                  <div key={monthIndex} className="flex items-center justify-center text-sm font-medium">
