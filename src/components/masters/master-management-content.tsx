  ...
  return (
    <div className="flex flex-col space-y-6">
              ...
              <div className="space-y-4">
                    ...
                    <TableHeader>
                      <TableRow>
                        <TableHead className="w-[50px]">
                          <Checkbox
                            checked={selectedItems.length === pageAccountItems.length}
                            onCheckedChange={() => toggleSelectAll(pageAccountItems)}
                          />
                        </TableHead>
                        <TableHead>勘定科目コード</TableHead>
                ...
                <div className="flex items-center justify-between">
                  <div className="text-sm text-gray-500">
                    {selectedItems.length} 件選択中 / 全 {filteredAccountItems.length} 件
                  </div>
                  <Pagination>
                    <PaginationContent>
                      <PaginationItem>
                      ...
                      {Array.from({ length: totalPages(filteredAccountItems) }, (_, i) => i + 1).map((page) => (
                      ...
                      <PaginationItem>
                        <PaginationNext
                          onClick={() =>
                            setCurrentPage((prev) => Math.min(prev + 1, totalPages(filteredAccountItems)))
                          }
                          className={
                            currentPage === totalPages(filteredAccountItems)
          ...
          <Card>
            ...
            <CardContent>
              <div className="space-y-4">
                  ...
                  <Table>
                    <TableHeader>
                      <TableRow>
                        <TableHead className="w-[50px]">
                          <Checkbox
                            checked={selectedItems.length === pageSupplierItems.length}
                            onCheckedChange={() => toggleSelectAll(pageSupplierItems)}
                          />
                        </TableHead>
                        <TableHead>取引先コード</TableHead>
                        <TableHead>取引先名</TableHead>
                        <TableHead>freee科目名</TableHead>
                ...
                <div className="flex items-center justify-between">
                  <div className="text-sm text-gray-500">
                    {selectedItems.length} 件選択中 / 全 {filteredSupplierItems.length} 件
                  </div>
                  <Pagination>
                    <PaginationContent>
                      <PaginationItem>
                      ...
                      {Array.from({ length: totalPages(filteredSupplierItems) }, (_, i) => i + 1).map((page) => (
                        <PaginationItem key={page}>
                          <PaginationLink
                            onClick={() => setCurrentPage(page)}
                            isActive={currentPage === page}
                      ...
                      <PaginationItem>
                        <PaginationNext
                          onClick={() =>
                            setCurrentPage((prev) => Math.min(prev + 1, totalPages(filteredSupplierItems)))
                          }
                          className={
                            currentPage === totalPages(filteredSupplierItems)
                              ? "pointer-events-none opacity-50"
                              : ""
                          }
                        />
          ...
          <Card>
            ...
            <CardContent>
              <div className="space-y-4">
                  ...
                  <Table>
                    <TableHeader>
                      <TableRow>
                        <TableHead className="w-[50px]">
                          <Checkbox
                            checked={selectedItems.length === pageFactorItems.length}
                            onCheckedChange={() => toggleSelectAll(pageFactorItems)}
                          />
                        </TableHead>
                        <TableHead>変動要因コード</TableHead>
                        <TableHead>変動要因名</TableHead>
                ...
                <div className="flex items-center justify-between">
                  <div className="text-sm text-gray-500">
                    {selectedItems.length} 件選択中 / 全 {filteredFactorItems.length} 件
                  </div>
                  <Pagination>
                    <PaginationContent>
                      <PaginationItem>
                      ...
                      {Array.from({ length: totalPages(filteredFactorItems) }, (_, i) => i + 1).map((page) => (
                        <PaginationItem key={page}>
                          <PaginationLink
                            onClick={() => setCurrentPage(page)}
                            isActive={currentPage === page}
                      ...
                      <PaginationItem>
                        <PaginationNext
                          onClick={() =>
                            setCurrentPage((prev) => Math.min(prev + 1, totalPages(filteredFactorItems)))
                          }
                          className={
                            currentPage === totalPages(filteredFactorItems)
                              ? "pointer-events-none opacity-50"
                              : ""
                          }
                        />
          ...
          <Card>
            ...
            <CardContent>
              <div className="space-y-4">
                  ...
                  <Table>
                    <TableHeader>
                      <TableRow>
                        <TableHead className="w-[50px]">
                          <Checkbox
                            checked={selectedItems.length === pageUserItems.length}
                            onCheckedChange={() => toggleSelectAll(pageUserItems)}
                          />
                        </TableHead>
                ...
                <div className="flex items-center justify-between">
                  <div className="text-sm text-gray-500">
                    {selectedItems.length} 件選択中 / 全 {filteredUserItems.length} 件
                  </div>
                  <Pagination>
                    <PaginationContent>
                      <PaginationItem>
                      ...
                      {Array.from({ length: totalPages(filteredUserItems) }, (_, i) => i + 1).map((page) => (
                        <PaginationItem key={page}>
                          <PaginationLink
                            onClick={() => setCurrentPage(page)}
                            isActive={currentPage === page}
                      ...
                      <PaginationItem>
                        <PaginationNext
                          onClick={() =>
                            setCurrentPage((prev) => Math.min(prev + 1, totalPages(filteredUserItems)))
                          }
                          className={
                            currentPage === totalPages(filteredUserItems)
                              ? "pointer-events-none opacity-50"
                              : ""
                          }
                        />
      ...
      <Dialog open={showEditDialog} onOpenChange={setShowEditDialog}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle>{editItem ? "編集" : "新規追加"}</DialogTitle>
          </DialogHeader>
          <div className="space-y-4 py-4">
            {activeTab === "account" && (
              <>
                <div className="space-y-2">
                  <Label htmlFor="id">勘定科目コード</Label>
                  <Input id="id" value={editItem?.id || ""} />
                </div>
                <div className="space-y-2">
                  <Label htmlFor="name">勘定科目名</Label>
                  <Input id="name" value={editItem?.name || ""} />
                </div>
                <div className="space-y-2">
                ...
                <div className="flex items-center space-x-2">
                  <Checkbox id="active" defaultChecked={editItem?.active ?? true} />
            ...
            {activeTab === "supplier" && (
              <>
                ...
                <div className="space-y-2">
                  <Label htmlFor="freeeSubject">freee科目名</Label>
                  <Input id="freeeSubject" value={editItem?.freeeSubject || ""} />
                </div>
              </>
            )}
            ...
            {activeTab === "factor" && (
              <>
                <div className="space-y-2">
                  <Label htmlFor="id">変動要因コード</Label>
                  <Input id="id" value={editItem?.id || ""} />
                </div>
                <div className="space-y-2">
                  <Label htmlFor="name">変動要因名</Label>
                  <Input id="name" value={editItem?.name || ""} />
                </div>
                <div className="space-y-2">
                  <Label htmlFor="unit">単位</Label>
                  <Input id="unit" value={editItem?.unit || ""} />
                </div>
                <div className="space-y-2">
                  <Label htmlFor="description">説明</Label>
                  <Input id="description" value={editItem?.description || ""} />
                </div>
              </>
            )}
            ...
            {activeTab === "user" && (
              <>
                <div className="space-y-2">
                  <Label htmlFor="id">ユーザーコード</Label>
                  <Input id="id" value={editItem?.id || ""} />
                </div>
                <div className="space-y-2">
      ...
      <AlertDialog open={showDeleteDialog} onOpenChange={setShowDeleteDialog}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              選択した{selectedItems.length}件のデータを削除します。この操作は取り消せません。
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
